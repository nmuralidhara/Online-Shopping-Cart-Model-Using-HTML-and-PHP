...
<div class="sidenav">
  <ul class="nav navbar-nav">
  <li class="active"><a href="sc-1.php">Pending Orders</a></li>
  <li><a href="ip.php">In Progress Orders</a></li>
  <li><a href="delivered-1.php">Delivered Orders</a></li>
  </ul>
</div>	
<div class="sticky" id="employee_detail" style=" margin-left:80%; height:60%;width:20%;right:20%;background-color:green">
...
$(document).ready(function(){
    ...
    //document.load(document.getElementById())
    // $("#viewdata").click(functio(){
    //     alert("hello");
    // });
...
//     var checkBox = document.getElementById(employee_id);
...
//     }
//     alert(s);
//     document.getElementById('employee_detail').innerHTML = s;
...
// var header = document.getElementById("employee_detail");
